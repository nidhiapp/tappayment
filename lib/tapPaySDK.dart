...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> configureApp() async {
    GoSellSdkFlutter.configureApp(
        bundleId: "sa.friendimobile.vm",
        productionSecretKey: "pk_test_7A8W2Tpu4gm65SDtl3MdQwHI",
        sandBoxSecretKey: "sk_test_9LvuyJZpaiEIQlj4o731cVN6",
        lang: "en");
  }
  ...
  void handleSDKResult() {
    ...
    String trxMode = tapSDKResult!['trx_mode'];
